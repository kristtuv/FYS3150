...
int main(int argc, char* argv[])
{
    ...
    for (double Temperature = InitialTemp; Temperature <= FinalTemp; Temperature+=TempStep){
        ...
        WriteResultstoFile(NSpins, MCcycles, Temperature, ExpectationValues, AcceptedConfigurations);
...
void WriteResultstoFile(int NSpins, int MCcycles, double temperature, vec ExpectationValues, int AcceptedConfigurations)
{
