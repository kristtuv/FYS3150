...
def plotting(filename):
	...
	"""
	figure(1)
	plot(x1[:15000], y1[:15000])
	plot(x2[:40000], y2[:40000])
	plot(x3[:50000], y3[:50000])
	plot(x4[:100000], y4[:100000])
	xlabel("AU")
	ylabel("AU")
	...
	xlabel("AU")
	ylabel("AU")
	legend(["Jupiter", "Saturn", "Uranus", "Neptun", "Pluto"])
	savefig("JSUNP")

plotting("FullSolarSystem")
"""
get_data("FullSolarSystem")
